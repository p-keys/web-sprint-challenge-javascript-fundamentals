...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/*
The nested function is nested inside of myFunction() and the variable internal is is the myFunction scope meaning the nestedFunction is in the same scope and can access it. 
*/
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(a){
    ...
    {
      newarr.push(`name: ${a.animal_name}, scientific: ${a.scientific_name}`);
    })
    return newarr; 
  }
console.log(animalNames(zooAnimals)); 
  ...
  */
  ...
  function lowPopulationAnimals(a){
    let filteredarr = [];
    const filt = a.filter(function(a)
    {
      if(a.population < 5)
      {
        filteredarr.push(a); 
  ...
  */
  ...
  function USApop(a){
    const singleValue = a.reduce(function(accumulator, item){
